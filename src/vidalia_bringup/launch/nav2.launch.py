"""
nav2.launch.py -- Nav2 navigation stack for the Amiga robot (ROS 2 Foxy).
...
This file launches:
  * controller_server   -- local costmap + Regulated Pure Pursuit path follower
...
Usage
-----
  # With slam_rtabmap_lidar3d.launch.py already running in another terminal:

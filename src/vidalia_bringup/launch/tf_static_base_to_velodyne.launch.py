...
#   x = 0.85 m   (1 ft forward of the front-tire centres, ~0.55 m ahead of
#                base_link = half the ~1.10 m wheelbase; confirm half-wheelbase)
...
#   z = 0.800 m  (LiDAR spin-axis height above ground; tape, robot on wheels)
    ...
    # unit is Hi-Res, product-ID 0x24 — see lidar/lidar_driver.py).
    #
